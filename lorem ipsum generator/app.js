...
const value = document.querySelector("#para")
const generatepara = document.querySelector(".result")

btn.addEventListener("click", ()=> {
  inputpara(value.value)
})

function inputpara(para) {
  for(let i = 0; i < para; i++){
    generatepara.innerHTML += `<p class="result">${text[i]}</p>`
  }
 }
